...
const DEFAULT_SAMPLE_EVENTS: EventRow[] = [
  ...
  },
  {
    ...
    decision: 'deny',
    reason: 'Command graph detected quote obfuscation and piped remote shell execution.',
  ...
  },
  {
    ...
    resource: 'api.evil.test',
    decision: 'deny',
    reason: 'Session read secret material before outbound network access.',
